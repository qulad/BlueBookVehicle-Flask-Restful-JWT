...
from Resources.Listing import get_listingid, get_listing_details_from_listing_id, check_listing_id, edit_listing_list

class ListingListResource(Resource):
    """
    ListingListResource is used for listing a Listing table instance.
    Use HTTP PUT method.
    ...
    Request Responses:
        ...
        listing is already listed:
            Response Message: Listing is already listed.
            Response Code: 412
        listing deleted:
            Response Message: You have successfully listed the listing.
            Response Code: 200
    """
    @jwt_required()
    def put(self):
        ...
        if listing.listing_active:
            return {"message": "Listing is already listed."}, 412
        edit_listing_list(listing_id)
        return {"message": "You have successfully listed the listing."}, 200
