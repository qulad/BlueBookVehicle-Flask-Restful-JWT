...
class AdminDenyPendingEditListingResource(Resource):
    """
    AdminDenyPendingDenyListingsResource is used by admins to deny edited listing are waiting for approval.
    ...
    Responses:
        ...
        listing is not waiting for new approval:
            ...
            Response code: 403
        listing is approved:
            Response message: Listing is denied.
            Response code: 400
    """
    @jwt_required()
    def post(self):
        ...
        db.session.commit()
        return {"message": "Listing is denied."}, 400
