...
class AdminView20ListingResource(Resource):
    """
    AdminView20ListingResource is used by admins to see everything about the listing.
    Use HTTP GET method.
    ...
    Responses:
        ...
        lower_range is equal or lower than zero:
            ...
            Response code: 417
        listing are not found:
            Response message: Listing are not found.
            Response code: 404
        listing are found:
            Response message: list<listing>
            Response code: 200
    """
    @jwt_required
    def get(self):
        ...
        listings = Listing.query.filter(Listing.listing_id.in_([lower_range, upper_range]))
        if not listings.first():
            return {"message": "Listings are not found."}, 404
