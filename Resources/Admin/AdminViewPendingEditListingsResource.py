...
class AdminViewPendingEditListingsResource(Resource):
    """
    AdminViewPendingEditListingsResource is used by admins to see which edited listing are waiting for approval.
    Use HTTP GET method.
    ...
    Responses:
        ...
        user does not have admin privilages:
            ...
            Response code: 403
        no edited listings found:
            Response message: There are no edited listings waiting for approval.
            Response code: 204
        edited listings found:
            Response message: list<edited listings waiting for approval>
            Response code: 200
    """
    @jwt_required()
    def get(self):
        ...
        listings = Listing.query.filter_by(edit_waiting=True)
        if not listings.first():
            return {"message": "There are no edited listings waiting for approval."}, 204
