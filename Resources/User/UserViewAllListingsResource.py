...
from Resources.Listing import view_all_listings_from_user_id

class UserViewAllListingsResource(Resource):
    """
    UserViewAllListingsResource is used for accessing all listings a user has created.
    Use HTTP GET.
    Request requirement:
        user_name.
    Request constrains:
    ...
    def get(self):
        ...
        return view_all_listings_from_user_id(user["user_id"]), 200
